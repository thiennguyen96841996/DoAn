...
<div class="main-content">
	<div class="container-fluid">
		...
		<div class="text-right">
			...
			<a data-toggle="modal" data-target="#modal-lg" class="btn btn-success"><span class="fa fa-plus"></span> Nhóm bàn</a>
		</div>
		<div class="card">
			<div class="card-body">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center font-size-18">
									<a href="{{ route('tableGroup.edit', $value->id) }}" class="text-gray m-r-15"><i class="ti-pencil"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
		...
		<div class="modal fade" id="modal-lg">
            <div class="modal-dialog" role="document">
                <form method="POST" action="{{ route('tableGroup.store') }}">
                    <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div>
                                <h4 class="d-flex align-items-center h-100 head">Thêm nhóm bàn</h4>
                            </div>
                            <div class="container">
                                <div class="form-group">
                                    <label class="control-label">Tên nhóm bàn</label>
                                    <input type="text" class="form-control" name="nameban">
                                </div>
                                <div class="form-group">
