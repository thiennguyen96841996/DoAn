        ...
        <div class="row">
            <div class="col-md-8">
                <div class="page-header">
                    <h2 class="header-title">Báo cáo nhân viên</h2>
                    <div class="header-sub-title">
                        <nav class="breadcrumb breadcrumb-dash">
                            <a href="#" class="breadcrumb-item"><i class="ti-home p-r-5"></i>Trang chủ</a>
                            <a class="breadcrumb-item" href="{{ route('admin.customers') }}">Báo cáo nhân viên</a>
        ...
        <div class="card">
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-8 offset-md-4">
                    <div class="m-t-25">
                        Top nhân viên bán hàng nhiều nhất
                    </div>
                </div>
            </div>
            <div class="row">
